...
const ProductCard = ({img,title,price,id,index}) => {

  const router = useRouter()

  return (
    <div className='flex flex-col flex-shrink-0 w-56 group h-fit hover:shadow-lg m-4 cursor-pointer ' onClick={()=>router.push(`/${index}`)} >
